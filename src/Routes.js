...
import TradeSettingsCheck from './containers/TradeSettingsCheck';
...
export default ({ childProps }) => (
  <Switch>
    ...
    <AuthenticatedRoute path="/tradeSettingsCheck" exact component={TradeSettingsCheck} props={childProps} />
